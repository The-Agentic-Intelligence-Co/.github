...
- **Eclipse** – Perplexity Comet Alternative. Perplexity Comet Alternative. Chrome extension with browser automation, multi-tab chat, and video search & analysis, plus tab management features. Just BYOK.
- **Walt** – A computer-use AI agent that can interact with your browser and desktop apps as if you were doing it yourself. Teach it workflows via screen-share and voice.
